  ...
  return (
    <div style={{}}>
      ...
      <section style={{ marginTop: "10rem" }}>
        ...
        {socials.map((social) => (
          <div key={social._id} className="flex justify-center mt-8 space-x-6">
            <a
            ...
            <a href={social.Facebook} target="_blank" className="text-gray-400 hover:text-gray-500">
            ...
            <a href={social.Instagram} target="_blank" className="text-gray-400 hover:text-gray-500">
            ...
            <a href={social.Twitter} target="_blank" className="text-gray-400 hover:text-gray-500">
            ...
            <a href={social.GitHub} target="_blank" className="text-gray-400 hover:text-gray-500">
            ...
            <a href={social.LinkedIn} target="_blank" className="text-gray-400 hover:text-gray-500">
